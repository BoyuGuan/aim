...
if __name__ == '__main__':
    ans = []
    count = 0
    with  open('./monitorLog/spatial.txt', mode='r') as f:
        lines = f.readlines()
        sections = [ 435, 527, 619, 713, 805, 897, 990]
        for trueFile in [lines[340 :sections[0]], lines[sections[0]:sections[1]], lines[sections[1]:sections[2]], lines[sections[2]:sections[3]]]:
